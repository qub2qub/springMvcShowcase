...
public class MessageConvertersController {
	...
	// (requires Jackson on the classpath - particularly useful for
	// serving JavaScript clients that expect to work with JSON)
	...
	// (requires Rome on the classpath - useful for serving Atom feeds)
	...
	public @ResponseBody Feed writeFeed() {
		...
		feed.setTitle("My Atom feed <--- Response from Server");
		return feed;
	}

	// RssChannelHttpMessageConverter
	// (requires Rome on the classpath - useful for serving RSS feeds)
	...
	public @ResponseBody Channel writeChannel() {
		...
		channel.setDescription("Description <--- Response from Server");
